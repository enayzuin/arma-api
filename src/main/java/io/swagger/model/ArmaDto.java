...
public class ArmaDto {
	...
	public ArmaDto nome(String nome) {
		this.nome = nome;
		return this;
	}
	...
	public ArmaDto raridade(String raridade) {
	...
	public ArmaDto dano(Integer dano) {
		this.dano = dano;
		return this;
	}
	...
	public ArmaDto status(Boolean status) {
		this.status = status;
		return this;
	}
	...
	public ArmaDto dtAtualizacao(OffsetDateTime dtAtualizacao) {
	...
	public ArmaDto tipo(TipoEnum tipo) {
		this.tipo = tipo;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		ArmaDto arma = (ArmaDto) o;
		return Objects.equals(this.id, arma.id) && Objects.equals(this.nome, arma.nome)
				&& Objects.equals(this.raridade, arma.raridade) && Objects.equals(this.dano, arma.dano)
				&& Objects.equals(this.status, arma.status) && Objects.equals(this.dtAtualizacao, arma.dtAtualizacao)
