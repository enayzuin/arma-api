...
public class ArmaApiController implements ArmaApi {
	...
	public ResponseEntity<Arma> alteraArma(
			@ApiParam(value = "Id da arma.", required = true) @PathVariable("id") Integer id,
		...
		try {
			...
			responseEntity = new ResponseEntity<Arma>(armaUpdate, getHeaderlocation(armaUpdate.getId()),
					HttpStatus.ACCEPTED);
	...
	public ResponseEntity<Arma> alteraStatusPorId(
	...
	public ResponseEntity<Arma> consultaPorId(
			@ApiParam(value = "Numero do Id da arma.", required = true) @PathVariable("id") Integer id) {
		ResponseEntity<Arma> responseEntity = null;
	...
	public ResponseEntity<Arma> consultaPorRaridade(
